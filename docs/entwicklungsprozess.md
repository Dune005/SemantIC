...
**Warum Gemini für die Analyse?** Ein direkter Vergleich mit Claude zeigte keinen Netto-Vorteil eines Wechsels: Claude fand in einem Testset mehr Kernfehler (5/6 gegenüber 3/6), war aber technisch fragiler (62,5 % Fehlerrate im Erstversuch), rund 3,5-mal langsamer und teurer. Gemini blieb Default – auch damit das live deployte Tool dem in der Thesis dokumentierten Verhalten entspricht. Die Architektur hält den Modellwechsel trotzdem offen (Claude direkt oder beliebige Modelle via OpenRouter).
